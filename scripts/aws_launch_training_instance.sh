...
Training config:
  ...
  the default serious-run workload, for example:
    ...
    ANTHROPIC_API_KEY=... LLM_PROVIDER=anthropic LLM_MODEL=claude-opus-4-6 \\
    RUN_STRESS_SIMULATOR=0 WORKERS=auto STRATEGY_PROVIDER=llm STRATEGY_CACHE_SCOPE=world_phase \\
...
PASSTHROUGH_ENV_VARS=(
  ...
  REPLAY_RECENT_CYCLE_WINDOW
  REPLAY_RECENT_BUCKET_WEIGHT
  REPLAY_KNOWN_BUCKET_WEIGHT
  REPLAY_COMPOSITION_BUCKET_WEIGHT
  REPLAY_FOUNDATION_BUCKET_WEIGHT
  STRATEGY_PROVIDER
  STRATEGY_FILE
